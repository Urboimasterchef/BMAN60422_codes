# -*- coding: utf-8 -*-
"""
Created on Sun Mar 30 18:10:31 2025
...
from sklearn.metrics import classification_report, accuracy_score, confusion_matrix, roc_curve, auc, roc_auc_score, average_precision_score, make_scorer, recall_score, precision_recall_curve
...
print(f'Specificity: {specificity_value:.3f}')
...
plt.scatter(fpr[np.argmax(tpr - fpr)], tpr[np.argmax(tpr - fpr)], color='red', label=f'Optimal Threshold = {best_threshold:.2f}')
...
print(f"\n🔹 Confusion Matrix (adjusted threshold = {best_threshold:.2f}):")
